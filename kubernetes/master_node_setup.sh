...
echo "============================================================================================"
echo "------------------------ Phase 1 - Installing Docker runtime -------------------------------"
echo "============================================================================================"
...
# Initializing kubeadm cluster with pod network - flannel
...
kubectl taint nodes wearify-master node-role.kubernetes.io/control-plane-
...
# Enable bridge-nf-call-iptables and bridge-nf-call-ip6tables
